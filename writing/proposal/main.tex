...
\hypersetup{pdfsubject=Proposal for a Master's Thesis}
...
{Proposal for a Master's Thesis}% type
{\today}% date
...
\include{chapter/02_goals}
\include{chapter/03_foundations}
\include{chapter/04_approach}
\include{chapter/05_schedule}
