...
\ \\
Furthermore, as the comparison with the other tools in the prior chapter already established, fulfills Ecoscape a majority of the requirements layed out by the requirements catalogue.
...
A detectable gap is present in the amount of pre-configured examples, as Ecoscape currently only has a use-case example with object recognition deployment and a older demo use-case about a distributed event factory.
