...
A detectable gap is present in the amount of ready-to-deploy examples, as Ecoscape currently only has a use-case example with object recognition deployment and a older demo use-case about a distributed event factory.
